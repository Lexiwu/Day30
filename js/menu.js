...
$(function () {  
    ...
    // subscribed by the email   


        $('.email-btn').click(function () {
           

            var validator = $("#e-type").validate({
                rules: {                    
                    Email: { required: true, email: true }                
                },
                messages: {                    
            ...
            //    var info_Email = $(".subscribe-newsletter").eq(1).val();

            //    var client_Email = {
            //        Email: info_Email,
            //    };

            //    var emaildata = JSON.stringify(client_Email);

            //    $.post("http://localhost/myapi/api/myapi", emaildata)
            //     .done(function (client_data) {
            //         alert('新增資料成功!!');
            //     })
            //} else return false;
        });//.email-btn click ending
